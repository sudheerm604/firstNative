...
- (void)viewDidLoad
{
   ...
   // dataRows = [[NSMutableArray alloc]initWithObjects:@"hello",@"world", nil];
    
    SFRestRequest *request = [[SFRestAPI sharedInstance] requestForQuery:@"SELECT Name FROM User LIMIT 100"];
